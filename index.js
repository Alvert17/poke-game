...
botonJuego.addEventListener("click", () => {
    ...
    subtitulo.classList.remove("segundaSuperClase"); 
...
if(entrada.value.toLowerCase().trim() === valorObjetoDeRepuesta.name){
   entrada.value ="";
    ...
    subtitulo.style.textShadow ="5px 4px 2px rgba(0, 0, 0, 1)";
    sumaPuntos += 1;
...
switch(sumaPuntos){
    case 5:
        subtitulo.innerText = "5 puntos? no lo haces nada mal.."
        subtitulo.style.color = "rgba(199, 70, 10, 1)"
        subtitulo.classList.add("segundaSuperClase"); 
    ...
    case 15:
        subtitulo.innerText = "10pts? sabes mucho de pokemon"
    ...
    case 18:
       ...
       subtitulo.classList.add("segundaSuperClase"); 
       subtitulo.innerText = `¡ oyee ERES UN MAESTRO POKEMON!`
